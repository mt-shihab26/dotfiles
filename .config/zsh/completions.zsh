# Tab-completion for the `omarchy` CLI dispatcher. Ported verbatim from
# Omarchy's bash completions file via zsh's bash-completion compatibility
# layer, since it's already exhaustively maintained upstream and reimplementing
# it against zsh's native compsys would drift from that source of truth.
