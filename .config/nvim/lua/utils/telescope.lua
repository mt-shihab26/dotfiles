...
function M.grep_files()
  require("telescope").extensions.live_grep_args.live_grep_args({
    ...
    vimgrep_arguments = {
      "rg", "--hidden", "-L", "--color=never", "--sort=path",
      "--no-heading", "--with-filename", "--line-number", "--column",
      "--smart-case", "--glob=!.git/*", "--glob=!composer.lock",
      "--glob=!pnpm-lock.yaml", "--glob=!package-lock.json", "--glob=!yarn.lock",
    },
  })
end
...
function M.grep_all_files()
  require("telescope").extensions.live_grep_args.live_grep_args({
    ...
    vimgrep_arguments = {
      "rg", "--hidden", "--no-ignore", "-L", "--color=never", "--sort=path",
